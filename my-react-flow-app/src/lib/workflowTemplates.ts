...
// 5. NEW TEMPLATES
import { ENHANCEMENT_CLAHE_TEMPLATE, ENHANCEMENT_ZERODCE_TEMPLATE,
} from './templates/enhancement';
// 6. Restoration
import { RESTORATION_REALESRGAN_TEMPLATE, RESTORATION_DNCNN_TEMPLATE,} from './templates/restoration';
// 7. Segmentation
import { SEGMENTATION_DEEPLAB_TEMPLATE, SEGMENTATION_MASKRCNN_TEMPLATE, 

} from './templates/segmentation';
...
export const TEMPLATES: WorkflowTemplate[] = [
  ...
  ENHANCEMENT_ZERODCE_TEMPLATE,
  RESTORATION_REALESRGAN_TEMPLATE,
  RESTORATION_DNCNN_TEMPLATE,
  SEGMENTATION_DEEPLAB_TEMPLATE,
  SEGMENTATION_MASKRCNN_TEMPLATE,
];